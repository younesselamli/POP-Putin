...
public class ShareButton : MonoBehaviour
{
    ...
    {
        var shareSubject = "Play POPPutin Game on your phone and challenge your friends"; //Subject text
        var shareMessage = "Get POPPutin game from Google Play Store: " + //Message text
                           gameLink;//Your link
